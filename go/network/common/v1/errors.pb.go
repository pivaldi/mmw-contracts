...
type DomainError struct {
	...
	Code          int32                  `protobuf:"varint,1,opt,name=code,proto3" json:"code,omitempty"` // maps to the module-specific error enum (e.g. TodoErrorCode)
...
func (x *DomainError) GetCode() int32 {
	if x != nil {
		return x.Code
	}
	return 0
...
func (x *DomainError) GetMessage() string {
	if x != nil {
		return x.Message
	}
	return ""
...
const file_common_v1_errors_proto_rawDesc = "" +
	...
	"\rcom.common.v1B\vErrorsProtoP\x01Z>github.com/pivaldi/mmw-contracts/go/network/common/v1;commonv1\xa2\x02\x03CXX\xaa\x02\tCommon.V1\xca\x02\tCommon\\V1\xe2\x02\x15Common\\V1\\GPBMetadata\xea\x02\n" +
...
var file_common_v1_errors_proto_goTypes = []any{
	(*DomainError)(nil), // 0: common.v1.DomainError
}
