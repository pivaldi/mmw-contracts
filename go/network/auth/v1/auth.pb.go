...
const file_auth_v1_auth_proto_rawDesc = "" +
	...
	"\rValidateToken\x12\x1d.auth.v1.ValidateTokenRequest\x1a\x1e.auth.v1.ValidateTokenResponseB\x91\x01\n" +
	"\vcom.auth.v1B\tAuthProtoP\x01Z:github.com/pivaldi/mmw-contracts/go/network/auth/v1;authv1\xa2\x02\x03AXX\xaa\x02\aAuth.V1\xca\x02\aAuth\\V1\xe2\x02\x13Auth\\V1\\GPBMetadata\xea\x02\bAuth::V1b\x06proto3"
